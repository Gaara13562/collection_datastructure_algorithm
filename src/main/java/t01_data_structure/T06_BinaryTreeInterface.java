...
import t01_data_structure.T06_SelfDefinedBinaryTree.Node;
 ...
 *
 */
public interface T06_BinaryTreeInterface<E> {
	/**
	 * 是否空树
	 * 
	 * @return
	 ...
	 * @return
	 */
	public Node<E> findKey(E value); // 查找
	...
	/**
	 * 中序遍历非递归操作 1）对于任意节点current，若该节点不为空则将该节点压栈，并将左子树节点置为current，重复此操作，直到current为空。
